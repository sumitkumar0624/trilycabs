...
import { Options, SassException } from "sass";
import { Transform } from "stream";
import { RawSourceMap } from "source-map";
export declare type SassOption = Omit<Options, "data" | "file">;
...
export declare const sass: GulpSass;
export interface GulpSassSync {
    (pluginOptions?: SassOption): Transform;
    logError(error: SassError): void;
}
export declare const sassSync: GulpSassSync;
